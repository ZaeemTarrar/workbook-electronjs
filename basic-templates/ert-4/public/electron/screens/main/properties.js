...
module.exports = (WindowState) => {
	if (WindowState === null || WindowState === undefined) throw new Error('Window State is Not Passed in Properties');
	let macOsProps = {
	...
	if (consoleInformation) console.log('Operating System Properties: ', properties);
